...
class Quiz_Maker_Public
{
    ...
    /*******************************************************************************************************/
        ...
        if(array_key_exists('hide_score',$options) && $options['hide_score'] != 'on'){
            $class = '';
             // $custom_name = '';
            $show_score_html = "<p class='ays_score ays_score_display_none animated {$title}'>Your '".$title."' score is </p>";
    ...
    /*******************************************************************************************************/
        ...
        if($id == '2'){
            $maturity_title = 'Business Continuity And Sustainability Maturity';
        }else if($id == '4'){
            $maturity_title = 'Cyber Security Maturity';
        }else if($id == '5'){
            $maturity_title = 'Regulatory Compliance Maturity';
        }
        ...
        $main_content_last_part = "<div class='step ays_thank_you_fs test'>
            ...
            "<div class='ays_quiz_results_page'>
                ...
                $ays_social_links .
                $progress_bar_html .
                // "<div class='matrix'> '".$maturity_title."'   <div class='matrix_a_title'><h2></h2><a href='#'></a></div> </div>".
                "<p class='ays_restart_button_p'>".
                    $restart_button_html .
                    $exit_button .
                "</p>".
                $quiz_rate_html .
                "<div class='result_title_c'><p>Please contact our experts to improve your maturity:</p></div>".
                "<div class='user-mail'> <div class='e-id'>Email: <a href='mailto:info@bizzsecure.com'>info@bizzsecure.com</a></div> <div class='c-id'>Contact: <a href=href='tel:833.249.9732'>tel:833.249.9732</a></div> </div>".
                "<p class='disclaimar'><b>Disclaimer:</b>This score is provided based on brief questionnaire. These questions are based on BizzSecure experience in assessments and audit. This score is not based on your company infrastructure.</p>".
                "</div>
            </div>
        </div>";
    ...
    protected function add_results_to_db($data){
        ...
        if($quiz_id == '2'){
            $quiz_title = 'Business Continuity And Sustainability Maturity';
        }else if($quiz_id == '4'){
            $quiz_title = 'Cyber Security Maturity';
        }else if($quiz_id == '5'){
            $quiz_title = 'Regulatory Compliance Maturity';
        }else{
            $quiz_title = 'Evaluated Company Maturity Score';
        }
  ...
  <head>
    ...
    <title>BizzSecure</title>
  </head>
  <body style="margin:0; padding:0;">
    <table style="margin:0 auto; padding:0; width:1200px; border:0; border-spacing:0; border-collapse:collapse;">
      <tr>
        <td style="text-align:center; background:#fff; padding:55px 0; background:#fff;"><a href="https://dev.bizzsecure.com/" target="_blank"><img src="https://dev.bizzsecure.com/wp-content/uploads/2018/12/1.png" alt="BizzSecure" /></td>
      </tr>
      <tr>
        <td style=" text-align:center; font-family:Roboto; color:#403e3f; font-size:32px; font-weight:600; background:#f2f2f2; padding:35px 0; line-height:60px; box-shadow:inset 0 5px 5px 0 rgba(0,0,0,.1);"><span style="vertical-align:top; margin:0 10px 0 0;"><img style="vertical-align:top;" src="https://dev.bizzsecure.com/wp-content/uploads/2020/07/Email.png" alt="Email" /></span> Email</td>
      </tr>
      <tr>
        <td style="margin:0; padding:59px 105px 94px;">
          <table style="margin:0 auto; padding:; width:100%; border:0; border-spacing:0; border-collapse:collapse;">
            <tr>
              <td style="padding:0 0 30px;font-family:Roboto;color:#333; font-size:32px; font-weight:600; line-height:32px; letter-spacing:.04em;">Dear Vivek,</td>
            </tr>
            <tr>
              <td style="font-family:Roboto;color:#787878; font-size:20px; font-weight:600; line-height:32px; letter-spacing:.03em;">This is to certify that someone has Evaluated the '.$quiz_title.' <br/> with score of '.$score.' / 100. Please contact Him/Her for the same.</td>
            </tr>
            <tr>
              <td style="padding:0 0 50px;">
                <table style="margin:0 auto; padding:; width:100%; border:0; border-spacing:0; border-collapse:collapse;">
                  <h3 style="font-family:Roboto; font-size:20px; font-weight:600; line-height:32px; letter-spacing:.04em; color: #333;">Here is the provided information:</h3>
                  <tr>
                    <td style="font-family:Roboto;color:#787878; font-size:17px; font-weight:600; line-height:32px; letter-spacing:.04em; display: block;">First Name: '.$user_name.'</td>
                    <td style="font-family:Roboto;color:#787878; font-size:17px; font-weight:600; line-height:32px; letter-spacing:.04em; display: block;">Work Email: '.$user_email.'</td>
                    <td style="font-family:Roboto;color:#787878; font-size:17px; font-weight:600; line-height:32px; letter-spacing:.04em; display: block;">Phone: '.$user_phone.'</td>
                  </tr>
                </table>
              </td>
            </tr>
            <tr>
              <td style="font-family:Roboto;color:#787878; font-size:20px; font-weight:600; line-height:32px; letter-spacing:.04em;">(This is an automated email, so please do not reply to this email address)</td>
            </tr>
          </table>
        </td>
      </tr>
      <tr>
        <td style="background:#40c3eb; padding:15px 0; text-align:center;">
          <a href="https://www.linkedin.com/company/bizzsecure/" target="_blank" style="margin:0 5px; display:inline-block; vertical-align:top;"><img style="vertical-align:top" src="https://dev.bizzsecure.com/wp-content/uploads/2020/07/linkdin.png" target="_blank" alt="" /></a>
          <a href="https://www.youtube.com/channel/UCwv60MuJJboOuN1ZerjyNgw" target="_blank" style="margin:0 5px; display:inline-block; vertical-align:top;"><img style="vertical-align:top" src="https://dev.bizzsecure.com/wp-content/uploads/2020/07/youtube.png" alt="" /></a>
          <a href="https://www.facebook.com/bizzsecure/" target="_blank" style="margin:0 5px; display:inline-block; vertical-align:top;"><img style="vertical-align:top" src="https://dev.bizzsecure.com/wp-content/uploads/2020/07/facebook.png" target="_blank" alt="" /></a>
          <a href="https://twitter.com/infobizzsecure" target="_blank" style="margin:0 5px; display:inline-block; vertical-align:top;"><img style="vertical-align:top" src="https://dev.bizzsecure.com/wp-content/uploads/2020/07/Twitter.png"  alt="" /></a>
        </td>
      </tr>      
    </table>
  </body>
</html>';
          $to = "info@bizzsecure.com";
          $headers  = "MIME-Version: 1.0" . "\r\n";
          $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
          $headers .= "From: BizzSecure <info@bizzsecure.com> \r\n";
          $headers .= "Reply-To: info@bizzsecure.com \r\n";
     wp_mail($to,$subject,$email_body,$headers, null ,'-finfo@bizzsecure.com');
