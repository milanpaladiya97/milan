				...
				vc_map( array(
					...
					"params" => array(
						...
						array(
							...
							'suffix' => '',
							'step' => 1,
							'description' => __( 'Number of post to displace or pass over.', 'js_composer' )
						),
						array(
							"type" => "dropdown",
							"heading" => __("Skin type" , 'js_composer' ),
							...
							"value" =>array(
								...
								__("Style11", 'js_composer' )=>"s11",
								__("Style12", 'js_composer' )=>"s12",
								),
						...
						array(
							...
							'dependency' => array('element' => 'skin_type','value' => array('s1','s2','s3','s4','s5','s6','s7','s11','s12')),
