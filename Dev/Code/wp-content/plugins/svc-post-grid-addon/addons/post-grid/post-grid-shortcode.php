...
function svc_post_layout_shortcode($attr,$content=null){
	...
	if($ajax){
		$offset = $offset + ( $paged - 1 ) * $query_posts_per_page;	
	}
		$query_final=array(
	...
	<?php }elseif($skin_type == 's12'){?>
	div.svc_post_grid_<?php echo $svc_grid_id;?> article section{ background:<?php echo $pbgcolor;?> !important;}
	div.svc_post_grid_<?php echo $svc_grid_id;?> article:hover section{ background:<?php echo $pbghcolor;?> !important;}
	<?php }?>
	...
	<?php }
	if($skin_type == 's1' || $skin_type == 's11' || $skin_type == 's12' || $skin_type == 's2' || $skin_type == 's4' || $skin_type == 's5' || $skin_type == 's8'){?>
	...
	<?php
		...
		<?php if($img_id != ''){?>
		  <header>
			...
			<span class="jl_date_overlay"><span class="jl_date_month"><?php echo get_the_date('M');?></span><span class="jl_date_day"><?php echo get_the_date('d');?></span><span class="jl_date_year"><?php echo get_the_date('Y');?></span></span>
            <?php }?>
		  </header>
		<?php }?>
		  <section>
