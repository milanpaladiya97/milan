	...
	public function es_newsubscriber_callback() {
		...
		if ( Email_Subscribers::get_request( 'email' ) ) {
			...
			$data  = array(
				...
				'last_name' => Email_Subscribers::get_request( 'subscriber_last_name' ),
				'email'      => $email,
				'source'     => 'admin',
				'status'     => 'verified',
		...
		$form = '<form method="post" action="' . $action . '">
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr class="form-field">
                                <td><label><b>' . __( 'Last Name', 'email-subscribers' ) . '</b></label></td>
                                <td><input type="text" id="last_name" name="subscriber_last_name" value="' . $last_name . '"/></td>
                            </tr>
                            <tr class="form-field">
