...
class ES_Forms_Table extends WP_List_Table {
	...
	public function es_new_form_callback() {
		...
		if ( 'submitted' === $submitted ) {
			...
			$validate_data = array(
				...
				'last_name'  => ! empty( $form_data['last_name'] ) ? $form_data['last_name'] : '',
	...
	public function prepare_list_form( $id = 0, $data = array() ) {
		...
		$form_data['last_name']          = ! empty( $data['last_name'] ) ? $data['last_name'] : '';
		$form_data['last_name_visible']  = ! empty( $data['last_name_visible'] ) ? $data['last_name_visible'] : 'no';
		$form_data['last_name_required'] = ! empty( $data['last_name_required'] ) ? $data['last_name_required'] : 'no';
		$form_data['last_name_label']    = ! empty( $data['last_name_label'] ) ? $data['last_name_label'] : '';
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table class="">
                                                ...
                                                <tr class="form-field">
                                                    <td><?php _e( 'First Name', 'email-subscribers' ); ?></td>
                                                ...
                                                <tr class="form-field">
                                                    <td><?php _e( 'Last Name', 'email-subscribers' ); ?></td>
                                                    <td><input type="checkbox" class="es_visible" name="form_data[last_name_visible]" value="yes" <?php if ( $form_data['last_name_visible'] === 'yes' ) {
															echo 'checked="checked"';
														} ?> /></td>
                                                    <td><input type="checkbox" class="es_required" name="form_data[last_name_required]" value="yes" <?php if ( $form_data['last_name_required'] === 'yes' ) {
															echo 'checked=checked';
														} ?>></td>
                                                    <!-- <td> <input type="text" class="es_name_label" name="form_data[name_label]"  value="<?php echo $form_data['name_label']; ?>" <?php if ( $form_data['name_required'] === 'yes' ) { echo 'disabled=disabled'; } ?> ></td>-->
                                                </tr>
	...
	public static function prepare_form_data( $data ) {
		...
		$last_name_label    = ! empty( $data['last_name_label'] ) ? $data['last_name_label'] : '';
		...
		$last_name_visible  = ( ! empty( $data['last_name_visible'] ) && $data['last_name_visible'] === 'yes' ) ? true : false;
		$last_name_required = ( ! empty( $data['last_name_required'] ) && $data['last_name_required'] === 'yes' ) ? true : false;
	...
	public static function get_form_data_from_body( $data ) {
		...
		foreach ( $body_data as $d ) {
			...
			}elseif ( $d['id'] === 'last_name' ) {
				$form_data['last_name_visible']  = ( $d['params']['show'] === true ) ? 'yes' : '';
				$form_data['last_name_required'] = ( $d['params']['required'] === true ) ? 'yes' : '';
				$form_data['last_name_label'] = !empty($d['params']['label']) ? $d['params']['label'] : '';
